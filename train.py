...
def train(
    ...
    generator.to(device, memory_format=torch.channels_last)
    ...
    for epoch in range(num_epochs):
        ...
        for x, y in track(
            ...
            d_real_loss = bce_loss(
                torch.ones_like(d_real_result, device=device),
                d_real_result,
            )
            ...
            d_fake_loss = bce_loss(
                torch.zeros_like(d_fake_result, device=device),
                d_fake_result,
            )
            ...
            g_loss = bce_loss(
                d_result,
                torch.ones_like(d_result, device=device)
